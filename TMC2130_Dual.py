...
try:
    ...
    MyTMC2130_1.Write(MyTMC2130_1.Reg_CHOPCONF,
                    0x08028008)  # CHOPCONF: MicroStep: full, TOFF=?, HSTRT=?,HEND=?,TBL=36(speadCycle)
    ...
    MyTMC2130_2.Write(MyTMC2130_2.Reg_CHOPCONF,
                      0x08028008)  # CHOPCONF: MicroStep: full, TOFF=?, HSTRT=?,HEND=?,TBL=36(speadCycle)
    ...
    MyTMC2130_2.Write(MyTMC2130_2.Reg_PWMCONF,
                      0x00050480)  # PWM_CONF: AUTO=?, ? Fclk, Switch amplitude limit = ?, Grad=?
